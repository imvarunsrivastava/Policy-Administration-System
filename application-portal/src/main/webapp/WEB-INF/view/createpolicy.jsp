          ...
          style="color: rgb(236, 243, 194);padding-right: 20px;">Logout</a></li>
                ...
                <body>
                    ...
                    <div class="container d-flex justify-content-between border rounded shadow mt-5 "
                        style="padding: 0px !important;height: 300px;width: 500px;">
                        
                        <div class="inputbox mx-2" style="flex: 1;">

                            <h1 style="text-align: center; color:rgb(6, 37, 105);"><b>Create Policy</b></h1><br>
                            <form:form action="/policy/createpolicy" method="POST" modelAttribute="createPolicyRequest">
                                <form:input path="consumerId" type="hidden" value="${consumerId}" />
                                <div class="row g-2  mb-3">
                                    <div class="col-md">
                                        <div class="form-floating">
                                            <form:input path="acceptedQuotes" type="text" class="form-control"
                                                id="acceptedQuotes" placeholder="Enter Accepted Quotes"
                                                name="acceptedQuotes" />
                                            <label for="floatingInputGrid">Accepted Quotes</label>
                                        </div>
                                        <form:errors path="acceptedQuotes" cssClass="error" style="font-size:13px" />
                                    </div>
                                </div>
                                <div class="row g-2  mb-0">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <div class="text-center"><button type="submit" class="btn btn-success">Create
                                                Policy</button></div>
                                    </div>
                                </div>
