      ...
      <body>
        ...
        <div class="container d-flex justify-content-between border rounded shadow mt-1 "
          ...
          <div class="inputbox mx-2" style="flex: 1;">
            <form:form action="/consumer/consumerbusiness" method="POST" modelAttribute="consumerBusinessRequest">
              <div>
                <div class="row my-2">
                  <h1 style="text-align: center; color:rgb(6, 37, 105);font-size: 34px !important;
                  font-weight: 400 !important;">Create Consumer Business</h1>
                </div>
                ...
                <div class="row g-2 mb-3">
                  ...
                  <div class="col-md">
                    <div class="form-floating">
                      <form:input path="validity" type="text" class="form-control" id="validity"
                ...
                <div class="row g-2  mb-0">
                  <div class="col-md">
                    <div class="text-center"><a href="/home/businessoption" class="btn btn-danger" role="button">Back</a></div>
