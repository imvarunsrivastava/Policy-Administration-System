  ...
  <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
      ...
      <body>
        ...
        <div id="box">
          <div id="pink">Welcome to Property Profile!!!!!</div>


          <div id="small">
            <a href="/consumer/consumerproperty"><button id="b2" type="button">Create
                Consumer Property</button></a></br></br>
            <a href="/consumer/viewconsumerpropertylist"><button id="b2" type="button">View
                Consumer Property</button></a>
            </p>
          </div>
